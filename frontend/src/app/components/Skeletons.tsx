...
export function ChartSkeleton({
  ...
  const chartHeight = minimal ? "h-[200px]" : bento ? "h-[320px]" : "h-[280px]";
  const wrapperClass = bento
    ? "bg-white dark:bg-slate-900 p-8 rounded-[3rem] border border-slate-100 shadow-sm flex flex-col space-y-6 h-full"
  ...
  return (
    <div className={cn(wrapperClass, className)}>
      ...
      {/* Chart body */}
      {type === 'bar' ? (
        <div className={cn("flex items-end gap-2 w-full pt-2", chartHeight)}>
          {[...Array(8)].map((_, i) => (
            <Skeleton
              key={i}
...
export function TableSkeleton() {
  return (
    <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] border border-slate-100 overflow-hidden shadow-sm">
...
export function InventoryTableSkeleton() {
  return (
    <ResponsiveTable
      label="Inventory table loading"
      scrollerClassName="rounded-none border-0 bg-transparent"
      minWidthClassName="min-w-[760px]"
    >
    <table className={TABLE.base} aria-label="Inventory table loading">
       <thead>
...
export function PredictionTableSkeleton() {
  return (
    <ResponsiveTable
      label="Prediction table loading"
      scrollerClassName="rounded-none border-0 bg-transparent"
      minWidthClassName="min-w-[980px]"
    >
       <table className={TABLE.base} aria-label="Prediction table loading">
          <thead>
             <tr className="bg-slate-50/50">
                {[...Array(6)].map((_, i) => (
        ...
        <div key={i} className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-100 shadow-sm">
           ...
           <div className="pt-5 border-t border-slate-50 flex items-center justify-between gap-4">
              ...
              <div className="shrink-0 space-y-1">
                 <Skeleton className="h-4 w-[50px] rounded opacity-40" />
    ...
    <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 shadow-sm overflow-hidden flex flex-col">
       <div className="p-8 border-b border-slate-50 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          <div className="space-y-2">
             ...
             <Skeleton className="h-4 w-[500px] rounded-full opacity-30" />
          </div>
       ...
       <ResponsiveTable
          label="Overview table loading"
          scrollerClassName="rounded-none border-0 bg-transparent"
          minWidthClassName="min-w-[980px]"
       >
          <table className={TABLE.base} aria-label="Overview table loading">
             <thead>
                <tr className="bg-slate-50/50">
                   {[...Array(6)].map((_, i) => (
